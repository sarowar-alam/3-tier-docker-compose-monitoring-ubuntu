...
display_summary() {
    ...
    echo ""
    echo -e "${GREEN}SUCCESS: PostgreSQL installed and running${NC}"
    echo -e "${GREEN}SUCCESS: Database '$DB_NAME' created${NC}"
    echo -e "${GREEN}SUCCESS: User '$DB_USER' created with privileges${NC}"
    echo -e "${GREEN}SUCCESS: Migrations completed${NC}"
    echo -e "${GREEN}SUCCESS: Connection tested successfully${NC}"
    echo -e "${GREEN}SUCCESS: Environment file generated${NC}"
    echo -e "${GREEN}SUCCESS: Backup/Restore scripts created${NC}"
    echo ""
